...
- 인스턴스(추천) > cluster 시작
```shell
minikube start --cpus 6 --memory 10120 --disk-size=100g --kubernetes-version=v1.21.12
```
- 인스턴스(최소) > cluster 시작
```shell
...
---
### 단계5-1: virtualbox > Kubeflow dashboard 접속
...
---
### 단계5-2: [aws ec2 > Kubeflow dashboard 접속](https://medium.com/@okpo65/on-premise-kubeflow-installation-on-aws-ec2-7256453d67c2)
- port-forward
```shell
...
---
- dashboard url: http://[Public IPv4 address]:8080
- Email / Password: user@example.com / 12341234
