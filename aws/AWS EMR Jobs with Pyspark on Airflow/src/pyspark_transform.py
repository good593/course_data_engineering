...
def transform_date():
    raw_data_s3_bucket = "s3://course-good593/airflow/raw-data/city_market_tracker.tsv000.gz"
    transform_data_s3_bucket = "s3://course-good593/airflow/transform-data/redfin_data.parquet"
...
if __name__ == "__main__":
    ...
    spark = SparkSession.builder.appName("AirflowWithEMR").getOrCreate()
